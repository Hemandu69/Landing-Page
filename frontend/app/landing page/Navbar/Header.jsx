...
const Header = () => {
  ...
  const defaultHeaderBg =
    pathname === "/dashboard" ? "bg-[#F3F5FC]" : "bg-[#E2E5FD]";
  const headerBgClass = isScrolled ? "bg-transparent" : defaultHeaderBg;

  return (
    <header className={`sticky top-0 z-50 w-full ${headerBgClass}`}>
      <div
        className={`relative w-full rounded-b-[40px] border-b border-gray-100 bg-white transition-all duration-300 ease-out ${isScrolled ? "shadow-[0_12px_36px_rgba(0,0,0,0.10)]" : "shadow-xs"}`}
      >
        {/* Top Utility Bar */}
          ...
          <div className="mx-auto flex max-w-[1360px] h-8 items-center justify-between px-4 sm:px-6 lg:px-10 text-[13px]">
            ...
            <div className="hidden md:flex items-center gap-4 text-[#6656D9]">
              ...
              <div className="flex items-center gap-1.5 font-medium">
                <button
                  type="button"
                  className="px-1 text-[13px] hover:opacity-80"
                ...
                <button
                  type="button"
                  className="rounded-md bg-[#E0E7FF] px-2 py-0.5 text-[13px] font-semibold text-[#4338CA]"
              ...
              <button
                type="button"
                className="flex items-center justify-center p-0.5 hover:opacity-80"
              ...
              <button
                type="button"
                className="flex items-center gap-1.5 font-medium transition-colors hover:text-[#5244B8]"
              >
                <Image
...
<button
                  ...
                  className="hidden lg:flex transition-transform hover:scale-[1.02] cursor-pointer"
                >
                  <Image
                    src={loginBtn}
                    alt="Login"
              ...
              <div className="p-4 flex flex-col gap-3 flex-1">
                ...
                <div className="border-b border-gray-100 pb-2">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={18}
                      className={`transition-transform ${mobileExpandedSection === "opportunities" ? "rotate-180" : ""}`}
                    />
                  </button>
                ...
                <div className="border-b border-gray-100 pb-2">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={18}
                      className={`transition-transform ${mobileExpandedSection === "community" ? "rotate-180" : ""}`}
                    />
                  </button>
                ...
                <div className="border-b border-gray-100 pb-2">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={18}
                      className={`transition-transform ${mobileExpandedSection === "about" ? "rotate-180" : ""}`}
                    />
                  </button>
